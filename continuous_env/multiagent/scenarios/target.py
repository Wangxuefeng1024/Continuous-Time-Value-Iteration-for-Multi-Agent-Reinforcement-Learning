...
class Scenario(BaseScenario):
    ...
    def reset_world(self, world):
        ...
        p0 = np.array([0.33, 0.16], dtype=np.float32)
        p1 = np.array([0.1, -0.19], dtype=np.float32)
        p2 = np.array([-0.23, 0.55], dtype=np.float32)
